...
def main():
    parser = argparse.ArgumentParser(description="Load 2025 MYM submissions into contract_forum_export_v3_all.")
    parser.add_argument("--db-path", default=DB_DEFAULT, help="SQLite DB path")
