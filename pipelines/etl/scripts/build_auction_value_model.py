...
def main():
    ...
    print(
        "Outputs: "
        f"{LOG_DIR / 'adp_fetch_summary.csv'}, "
        f"{LOG_DIR / 'adp_normalization_summary.csv'}, "
        f"{LOG_DIR / 'auction_value_summary_v1.csv'}, "
        f"{LOG_DIR / 'auction_value_topn_summary_v1.csv'}, "
        f"{LOG_DIR / 'auction_team_budget_proxy_v1.csv'}, "
        f"{LOG_DIR / 'auction_player_value_model_v1.csv'}"
    )
