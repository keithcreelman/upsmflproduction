...
- DEFENDING CHAMPION: if the payload includes a "defending champion" field, that is THE owner who won the most recently completed season. Do not call anyone else "defending champion." If a roasted owner is the defending champ, lean into it. If they're not but you want to reference the chip, use phrasing like "his last title" or "back when he won in [year]."
