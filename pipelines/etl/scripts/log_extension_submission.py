...
def main() -> int:
    ...
    # Default --contract-year is the string "0", which is truthy via
    # safe_str() and would shadow the payload value (always reporting
    # contract_year as missing). Treat a CLI default of 0 as "absent"
    # so the payload is consulted instead.
