...
UPDATE ups_drop_events
   SET applies_to_season          = 2027,
       ...
       cap_season_review_reason   = 'Posted to the 2026 MFL cap in error; the adjustment was DELETED from MFL by the commish on 2026-08-08 (Keith chose a hand-delete over an offsetting entry, so the ledger stays visually clean). Owed on the 2027 cap.',
       posted_to_mfl              = 0,
       posted_at_utc              = NULL,
       posted_amount              = NULL,
