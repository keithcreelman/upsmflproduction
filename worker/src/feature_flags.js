...
export const FEATURE_FLAGS = [
  ...
  { key: "AUCTION_NIGHTLY_NUDGE_ENABLED", label: "FAA nightly nudge", help: "ON = at 9 PM ET each night during the FA Auction, post an out-of-compliance roll-up to the Auction Bidding channel + DM each owner who still owes nominations. Only fires when 'FAA auction live' is also ON. OFF = silent. Dry-run any time with POST /admin/auction/run-nightly-nudge?force=1." },
];
