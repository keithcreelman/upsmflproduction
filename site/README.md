...
## MFL Header field
```html
<script src="https://keithcreelman.github.io/upsmflproduction/site/loader.js?v=2026.02.14.3" data-ups-partial="header"></script>
```

## MFL Footer field
```html
<script src="https://keithcreelman.github.io/upsmflproduction/site/loader.js?v=2026.02.14.3" data-ups-partial="footer"></script>
```

## Any HPM slot (standard message)
```html
<script src="https://keithcreelman.github.io/upsmflproduction/site/loader.js?v=2026.02.14.3" data-ups-partial="hpm-default"></script>
```
...
<script
  src="https://keithcreelman.github.io/upsmflproduction/site/loader.js?v=2026.02.14.3"
