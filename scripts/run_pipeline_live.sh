...
export MFL_SALARY_ADJUSTMENTS_FILE="${MFL_SALARY_ADJUSTMENTS_FILE:-}"
export MFL_SALARY_ADJUSTMENTS_TIMEOUT="${MFL_SALARY_ADJUSTMENTS_TIMEOUT:-30}"
...
if [[ -n "$MFL_SALARY_ADJUSTMENTS_URL" ]]; then
  SALARY_ADJUSTMENTS_REPORT_ARGS+=(--salary-adjustments-url "$MFL_SALARY_ADJUSTMENTS_URL")
fi
if [[ -n "$MFL_SALARY_ADJUSTMENTS_FILE" ]]; then
  SALARY_ADJUSTMENTS_REPORT_ARGS+=(--salary-adjustments-file "$MFL_SALARY_ADJUSTMENTS_FILE")
fi
if [[ -n "$MFL_SALARY_ADJUSTMENTS_TIMEOUT" ]]; then
  SALARY_ADJUSTMENTS_REPORT_ARGS+=(--salary-adjustments-timeout "$MFL_SALARY_ADJUSTMENTS_TIMEOUT")
fi
